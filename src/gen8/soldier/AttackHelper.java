...
import static gen8.Soldier.allRobots;
import static gen8.soldier.SoldierMovementHelper.HEAL_THRESHOLD;
import static gen8.sage.SageMovementHelper.HP_THRESHOLD;
...
public strictfp class AttackHelper {
	...
	// SOLDIER
	// SAGE
	public static final int[] priority = {3, 1, 4, 0, 2, 5, 6};
